...
%prep
%setup -q -n Lexical-SealRequireHints-0.012
cd %{_builddir}
tar xf %{_sourcedir}/liblexical-sealrequirehints-perl_0.011-2.debian.tar.xz
cd %{_builddir}/Lexical-SealRequireHints-0.012
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Lexical-SealRequireHints-0.012/deblicense/
